...
export const Quotation_DEC_PDF = ({
  bill,
}: {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.block}>
          ...
          <View style={styles.row}>
            <Text>
              <Text style={styles.label}>GSTIN:</Text> 37CBEPD0169A1Z9
            </Text>
            <Text>
              <Text style={styles.label}>Phone:</Text> 9100817369
            </Text>
          </View>
          <Text>
          ...
          <Text style={{ marginTop: 6 }}>
            <Text style={styles.label}>To:</Text> {bill.to.name},{bill.to.ship} ,{bill.to.address}
          </Text>
        </View>
