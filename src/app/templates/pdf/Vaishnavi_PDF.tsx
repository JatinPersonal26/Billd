...
export const VaishnaviEnterprisesQuotation = ({ bill }: { bill: BillOrQuoteFinalType }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.companyHeader}>
        ...
        <View style={styles.rightPanel}>
          <Text style={styles.addressLine}>Date: {bill.date}</Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.label}>Quotation No:</Text> <Text>{bill.invoiceNo}</Text>
      </View>
...
export const VaishnaviEnterprisesBill= ({ bill }: { bill: BillOrQuoteFinalType }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.companyHeader}>
        <View style={styles.leftPanel}>
